...
<form action= "" method="POST">
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input required type="date" class="form-control" name="apnt_date" id="inputDate" min="<?php echo date("Y-m-d"); ?>" placeholder="Enter Date">
    </div>
    
    <div class="form-group col-md-6">
      <label for="inputTime">Appointment Time</label>
      <input required type="time" class="form-control" name="apnt_time" id="inputTime" placeholder="Enter Time">
    </div>
